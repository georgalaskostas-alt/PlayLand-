...
enum StoryLibrary {
    ...
    static let stories: [StoryContent] = [
        StoryContent(
            ...
            scenes: [
                StoryScene(background: AppAssets.Backgrounds.forestDay, characters: [BabisVisualState.neutral.plannedAssetName], narrationKey: "story.babisKotsifi.scene0.narration", choices: next(1), illustration: StoryIllustrations.BabisKotsifi.scene00),
                StoryScene(background: AppAssets.Backgrounds.forestDay, characters: [BabisVisualState.neutral.plannedAssetName, AppAssets.KotsifiStates.idle], narrationKey: "story.babisKotsifi.scene1.narration", choices: next(2), illustration: StoryIllustrations.BabisKotsifi.scene01),
                StoryScene(background: AppAssets.Backgrounds.forestDay, characters: [BabisVisualState.happy.plannedAssetName, AppAssets.KotsifiStates.talking], narrationKey: "story.babisKotsifi.scene2.narration", choices: next(3), illustration: StoryIllustrations.BabisKotsifi.scene02),
                StoryScene(background: AppAssets.Backgrounds.forestDay, characters: [BabisVisualState.happy.plannedAssetName, AppAssets.KotsifiStates.happy], narrationKey: "story.babisKotsifi.scene3.narration", choices: next(4), illustration: StoryIllustrations.BabisKotsifi.scene03),
                StoryScene(background: AppAssets.Backgrounds.forestDay, characters: [BabisVisualState.drinking.plannedAssetName, AppAssets.KotsifiStates.happy], narrationKey: "story.babisKotsifi.scene4.narration", choices: next(5), illustration: StoryIllustrations.BabisKotsifi.scene04),
